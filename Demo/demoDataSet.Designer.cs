...
namespace Demo {
    ...
    public partial class demoDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientRow AddClientRow(int id_clients, string login, string password, string FIO, string number) {
...
namespace Demo.demoDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Client] WHERE (([id_clients] = @Original_id_clients) AND ([log" +
                "in] = @Original_login) AND ([password] = @Original_password) AND ([FIO] = @Origi" +
                "nal_FIO) AND ([number] = @Original_number))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Client] ([id_clients], [login], [password], [FIO], [number]) V" +
                "ALUES (@id_clients, @login, @password, @FIO, @number);\r\nSELECT id_clients, login" +
                ", password, FIO, number FROM Client WHERE (id_clients = @id_clients)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [id_clients] = @id_clients, [login] = @login, [password] = @password, [FIO] = @FIO, [number] = @number WHERE (([id_clients] = @Original_id_clients) AND ([login] = @Original_login) AND ([password] = @Original_password) AND ([FIO] = @Original_FIO) AND ([number] = @Original_number));
SELECT id_clients, login, password, FIO, number FROM Client WHERE (id_clients = @id_clients)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id_clients, login, password, FIO, number FROM dbo.Client";
        ...
        public virtual int Delete(int Original_id_clients, string Original_login, string Original_password, string Original_FIO, string Original_number) {
        ...
        public virtual int Insert(int id_clients, string login, string password, string FIO, string number) {
        ...
        public virtual int Update(int id_clients, string login, string password, string FIO, string number, int Original_id_clients, string Original_login, string Original_password, string Original_FIO, string Original_number) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string login, string password, string FIO, string number, int Original_id_clients, string Original_login, string Original_password, string Original_FIO, string Original_number) {
            return this.Update(Original_id_clients, login, password, FIO, number, Original_id_clients, Original_login, Original_password, Original_FIO, Original_number);
        }
    }
